...
-   **If you already have Google Sign In configured**
    ...
    2.  Select your project and enable the **Maps Embed API** And **Maps SDK For Android** (Or one of them, not sure)
...
-   **If you already have not configured Google Sign In**
    ...
    3.  Once it's created, go to the project and enable the **Maps Embed API** And **Maps SDK For Android** (Or one of them, not sure)
